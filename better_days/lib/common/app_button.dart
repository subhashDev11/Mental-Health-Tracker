  ...
  Widget build(BuildContext context) {
    ...
    switch (variant) {
      case ButtonVariant.primary:
        backgroundColor = disabled ? colorScheme.primary.withOpacity(0.5) : colorScheme.primary;
        textColor = colorScheme.onPrimary;
        borderColor = Colors.transparent;
        break;
      case ButtonVariant.secondary:
        backgroundColor = disabled ? colorScheme.secondary.withOpacity(0.5) : colorScheme.secondary;
